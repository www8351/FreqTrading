...
input ENUM_TIMEFRAMES InpTriggerTf = PERIOD_M30; // SMC trigger TF (Python trigger_tf_min;
//                                                  XAUUSD live keeper runs M30). HTF=H4/D1 fixed.
...
input double  InpStage2Buffer     = 0.5;        // $ beyond candle-N low/high for the stage2 lock
...
ENUM_TIMEFRAMES g_trig_tf = PERIOD_M30;  // SMC trigger TF, resolved from InpTriggerTf in OnInit
